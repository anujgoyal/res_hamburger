...
class AppDelegate: UIResponder, UIApplicationDelegate, RESideMenuDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        var sideVC = RESideMenu(contentViewController: navVC,
            leftMenuViewController: leftVC,
            rightMenuViewController: nil)
        
        sideVC.menuPreferredStatusBarStyle = UIStatusBarStyle.LightContent
        sideVC.delegate = self
        //sideVC.contentViewShadowColor = UIColor.redColor()
        //sideVC.contentViewShadowOffset = CGSizeMake(0,0)
        //sideVC.contentViewShadowOpacity = 0.6;
        //sideVC.contentViewShadowRadius = 12;
        //sideVC.contentViewShadowEnabled = true
